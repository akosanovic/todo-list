...
// take content from the card input field
// create new card
// place content into newly renderd card
var ToDoCard = (function () {
    function ToDoCard(userInput) {
        this.userInput = userInput;
    }
    ToDoCard.prototype.renderCardMethod = function () {
    };
    ToDoCard.prototype.appendCard = function () {
        if (this.userInput) {
            $('.card--container').append(this.renderCard);
        }
    };
    return ToDoCard;
}());
$('document').ready(function () {
    var card = new ToDoCard("Hello world");
});
...
__WEBPACK_IMPORTED_MODULE_0_jquery__(document).ready(function () {
    var myMessage = new __WEBPACK_IMPORTED_MODULE_1__Message__["a" /* default */]();
    myMessage.show();
    var pageContainer = __WEBPACK_IMPORTED_MODULE_0_jquery__('.page--container');
    var cardContainer = pageContainer.find('.card--container');
    // event handlers
    ...
    function keypressHandler(e) {
        ...
        var selectedCard = target.closest(__WEBPACK_IMPORTED_MODULE_0_jquery__('.to--do--card'));
    ...
    function newToDoCard(selectedCard) {
        var input = selectedCard.find('.task--input');
